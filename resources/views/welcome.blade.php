...
<head>
    ...
    <title>IT-Beschaffungstool</title>
</head>
    ...
    <div class="wrapper">
        <div id="app">
                    ...
                    <nav class="navbar navbar-expand">
                        ...
                        <div class="user-box dropdown">
                            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                                ...
                                <img src="{{ asset('backend/assets/images/avatars/pro_pic1.jpeg') }}" class="user-img"
                                    alt="user avatar">
                                <div class="user-info ps-3">
                                    <p class="user-name mb-0">Sergen Yilmaz</p>
            ...
            <footer class="page-footer">
                <p class="mb-0">Copyright © 2022. All right reserved by <a
                        href="">Sergen</a></p>
            </footer>
