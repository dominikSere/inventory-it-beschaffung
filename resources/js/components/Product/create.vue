<template>
    <div>
        <div class="page-breadcrumb d-none d-sm-flex align-items-center">
            <div class="ms-auto">
                <div class="btn-group">
                    <router-link to="/product" class="btn btn-primary button"
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        >
                            ...
                            <div class="col-md-4">
                                <!-- <label for="inputSalary" class="form-label"
                                    >Price Per Amount</label
                                > -->
                                <input
                                    type="hidden"
                                    class="form-control"
                                    id="inputSalary" value="null"
                            ...
                            <div class="col-md-4">
                                <label for="inputSalary" class="form-label"
                                    >Price Per Amount or User</label
                                >
                                <input
                                    type="text"
                                    class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <small
                                    class="text-danger"
                                    v-if="errors.expired_date"
                                    >{{ errors.expired_date[0] }}</small
                                >
                            </div>
